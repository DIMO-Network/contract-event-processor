...
var BlockWhere = struct {
	...
	ChainID:     whereHelperint64{field: "\"contract_event_processor\".\"blocks\".\"chain_id\""},
}
...
var (
	blockAllColumns            = []string{"number", "hash", "processed_at", "chain_id"}
	blockColumnsWithoutDefault = []string{"number", "hash", "chain_id"}
	blockColumnsWithDefault    = []string{"processed_at"}
	blockPrimaryKeyColumns     = []string{"chain_id"}
...
func FindBlock(ctx context.Context, exec boil.ContextExecutor, chainID int64, selectCols ...string) (*Block, error) {
	blockObj := &Block{}
	...
	query := fmt.Sprintf(
		"select %s from \"contract_event_processor\".\"blocks\" where \"chain_id\"=$1", sel,
	)
...
func (o *Block) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"contract_event_processor\".\"blocks\" WHERE \"chain_id\"=$1"
...
func (o *Block) Reload(ctx context.Context, exec boil.ContextExecutor) error {
	ret, err := FindBlock(ctx, exec, o.ChainID)
	if err != nil {
		return err
	}
...
func BlockExists(ctx context.Context, exec boil.ContextExecutor, chainID int64) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"contract_event_processor\".\"blocks\" where \"chain_id\"=$1 limit 1)"
...
func (o *Block) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return BlockExists(ctx, exec, o.ChainID)
}
